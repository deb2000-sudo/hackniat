        ...
        <tbody>
          {sessions.map((s) => (
            <tr key={s.id}>
              ...
              <td>
                {publicationGated ? (
                  <Badge variant={s.report_published ? 'success' : 'warning'} dot>
                    {s.report_published ? 'Report published' : 'Submitted — results pending'}
                  </Badge>
                ) : (
              ...
              <td className="mono" style={{ fontWeight: 700 }}>
                {(!publicationGated || s.report_published) && s.overall_score != null
